...
PrimitiveKind = Literal["memory", "theme", "watch_item", "observation", "distillation", "style_note", "oob_entry", "orientation_item"]
...
def _parse_primitive_writes(value: Any, path: Path) -> list[PrimitiveWriteExpectation]:
    ...
    for index, item in enumerate(value):
        ...
        _expect_choice(
            kind,
            {"memory", "theme", "watch_item", "observation", "distillation", "style_note", "oob_entry", "orientation_item"},
            f"{label}.kind",
            path,
        )
