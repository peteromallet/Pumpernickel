...
SUPERPOM_READ_INSTRUCTION = (
    ...
    "load the user's principles, manifestations, goals, priorities, and anti-patterns for "
...
SUPERPOM_RECORD_INSTRUCTION = (
    ...
    "orientation items for principles, manifestations, goals, priorities, "
    "and anti-patterns — these are your Compass headings, distinct from "
    "memory facts, observation patterns, and distillation explanations. "
    "Manifestations are specific hoped-for moments in time and must include "
    "`target_date` as the manifest-by date. When the user states or implies "
    "a Compass heading, create it here "
