-- 0064_reflections_searchable_content.down: reverse 0064 by restoring the
-- 0059 source-type contract and searchable-content view.
--
-- Tightening the durable source-type checks requires removing any
-- 'reflection' rows from content_embeddings and embed_jobs first so the
-- legacy 0059 checks can be re-applied safely.
